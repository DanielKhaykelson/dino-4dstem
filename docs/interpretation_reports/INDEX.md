...
| IMC SI5 | [IMC_SI5__m0.9700_seed42_K60](IMC_SI5__m0.9700_seed42_K60/report_auto.md) | 13 | 16384 | no classical baseline reproduces the DINO partition (best ARI=0.2144, AMI=0.3) — the clustering is distinctive, not a re-labelling of a virtual-DF / radial / PCA / NMF map. |
